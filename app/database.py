...
class TicketRepository:
    def __init__(self, database_path: str | Path = "data/tickets.duckdb") -> None:
        ...
        Args:
            database_path (str | Path): Description of database_path.
        """
    ...
    def list(self, filters: TicketFilters | None = None) -> list[Ticket]:
        ...
        Args:
            filters (TicketFilters | None): Description of filters.
    ...
    def get(self, ticket_id: int) -> Ticket:
        ...
        Raises:
            TicketNotFoundError: Description of when this is raised.
        """
        with self._lock:
    ...
    def _now() -> datetime:
        ...
        Returns:
            datetime: Description of the return value.
        """
    ...
    def _row_to_ticket(row: Iterable[object]) -> Ticket:
        ...
        Args:
            row (Iterable[object]): Description of row.
